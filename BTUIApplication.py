...
from UI_lib.HOSTUI import TestApplication
...
class BluetoothUIApp(QMainWindow):
    ...
    def list_controllers(self):
        ...
        palette = QPalette()
        self.background_path = "/root/Desktop/BT_Automation/images/main_window_background.jpg"
...
if __name__ == "__main__":
    ...
    app_window.setWindowIcon(QIcon('/root/Desktop/BT_Automation/images/app_icon.jpg'))
